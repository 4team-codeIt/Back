...
public class JwtRequestFilter extends OncePerRequestFilter {
	...
	private final List<Map<String, String>> excludeUrls;

	@Override
	protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
		return excludeUrls.stream().anyMatch(entry ->
				pathMatcher.match(entry.get("url"), request.getServletPath()) &&
						("ALL".equalsIgnoreCase(entry.get("method")) || entry.get("method")
	...
	private void setErrorResponse(HttpServletResponse response, CustomException ex)
			throws IOException {
